    ...
    return (
      <Select
        ...
        classNames={{
          ...
          input: () => 'text-sm',
          menu: () =>
            'mt-2 rounded-lg border bg-popover text-popover-foreground shadow-md py-1',
          ...
          multiValue: () =>
            'inline-flex items-center bg-secondary text-secondary-foreground mr-1 rounded-lg',
          multiValueLabel: () => 'px-2 text-xs leading-none',
          multiValueRemove: () =>
            cn(
              'flex items-center justify-center p-1',
              'hover:bg-destructive hover:text-destructive-foreground rounded-lg'
            ),
          valueContainer: () =>
            'gap-1 flex flex-wrap items-center rounded-lg',
          clearIndicator: () =>
